...
<div id="sidebar" class="sidebar py-3">
 ...
 <ul class="sidebar-menu list-unstyled">
    ...
    <li class="sidebar-list-item"><a href="registrations.php" class="sidebar-link text-muted"><i class="o-clock-1 mr-3 text-gray"></i><span>Pending<br>Practioners</span></a></li>
     <li class="sidebar-list-item"><a href="pharmacist.php" class="sidebar-link text-muted active"><i class="o-clock-1 mr-3 text-gray"></i><span>Pending<br>Pharmacists</span></a></li>
          ...
          <div id="switchPoint" class="e-panel card">
              ...
              <div class="card-body">
                <div class="card-title">
                  <h6 class="mr-2"><span>Pharmacists</span><small class="px-1"></small></h6>
                </div>
                <div class="e-table">
                  <div class="table-responsive table-lg mt-3">
                    <table class="table table-bordered" id="myTable">
                      ...
                      <?php
                $i =0;
                $pharmacs = $pharmacy->getallPharmacists(); ?>
               ...
               <tr>
                       ...
                       <td><a class="text-success" href="#" onclick="event.preventDefault(),VerifyPharmacist(<?php echo $phar['id']; ?>)">Accept</a></td>

...
<html>
  ...
  <body onload="homeadmindetail(),getAllClients()">
    <!-- navbar-->
...
<ul class="sidebar-menu list-unstyled">
    ...
    <li class="sidebar-list-item"><a href="users.php" class="sidebar-link text-muted active"><i class="o-user-1 mr-3 text-gray"></i><span>Patients</span></a></li>
            ...
            <div class="card">
              <div class="card-body">
                <div class="text-center px-xl-3">
                  <button class="btn btn-success btn-block"  data-toggle="modal" data-target="#modalprimary" >New User</button>
                </div>
                <hr class="my-3">
            ...
            <div id="switchPoint" class="e-panel card">
              <div class="card-body">
                <div class="card-title">
                  <h6 class="mr-2"><span>Users</span><small class="px-1"></small></h6>
                </div>
                ...
                <div class="e-table">
                    <div class="container">
                        <div class="main-body">
                              <div class="row" id="mainConterPatient">
                  ...
                  <form class="form">
                    ...
                    <div class="row">
                       ...
                       <div  class="form-group">
                        <label>Select Gender</label>
                                <select class="form-control" id="cgender" name="cgender" required="required">
                      ...
                      <div class="col-md-6 form-div">
                        <div class="form-group">
                          <label>Physcal Address</label>
                          <input type="text" class="form-control" name="caddesss" placeholder="Physcal Address" required="required" id="caddesss">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row text-center">
                      <div class="col-md-12 text-center">
                        <button type="button" class="btn btn-success btn-lg" onclick="cregisterClient()" id="clientreg" >Add Client</button>
                         <input type="hidden" class="form-control"  id="cid">
                        <button id="updatebtn" class="btn btn-lg btn-primary" type="button" onclick="updateClientInfo()">Update</button>
                      </div>
                    </div>
                  </form>

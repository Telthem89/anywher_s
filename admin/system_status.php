...
<div class="page-holder w-100 d-flex flex-wrap">
  ...
  <section class="py-5" id="adminBody">
      <div class="row">
        ...
        <div class="container">
          <h2 class="heading1 text-center">System Status</h2>
          <p class="lead heading2 text-center">All system issues that need to be attended to</p> 
          <hr class="line-break" />
          <div class="row">
            <div class="col-lg-12">
              <p class="text-center text-mute">1 Issue found</p> 
            </div>
            <div class="col-lg-12">
              <a href="#replyMessage" data-toggle="modal" class="message card px-5 py-3 mb-4 bg-hover-gradient-primary no-anchor-style">
                <div class="row">
                  ...
                  <div class="col-lg-9 d-flex align-items-center flex-column flex-lg-row text-center text-md-left">
                    <p class="mb-0 mt-3 mt-lg-0 text-center">You may need to update your php version to PHP version 7 so as to
                     avoid problems with future updates.</p>
                  </div>
                </div>
              </a>
            </div>

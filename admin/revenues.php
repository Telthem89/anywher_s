...
<div id="sidebar" class="sidebar py-3">
  ...
  <ul class="sidebar-menu list-unstyled">
    ...
    <li class="sidebar-list-item"><a href="revenues.php" class="sidebar-link text-muted active"><i class="o-paper-stack-1 mr-3 text-gray"></i><span>Revenues</span></a></li>
...
<div class="page-holder w-100 d-flex flex-wrap">
  ...
  <section class="py-5" id="adminBody">
      <div class="row">
        ...
        <div class="container">
          <h2 class="heading1 text-center">All Revenues</h2>
          <hr class="line-break" />
          <div class="row">
            <div class="col-lg-12">
              here we go

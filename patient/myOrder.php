...
$drug = new Drugs();
$orders = $drug->getallMyOrdersForClient($_SESSION['patient_id']);
...
<ul class="sidebar-menu list-unstyled">
    ...
    <li class="sidebar-list-item"><a href="myOrder.php" class="sidebar-link text-muted active"><i class="o-profile-1 mr-3 text-gray"></i><span>My Orders</span></a></li>
  </ul>
</div>
          ...
          <table class="table table-bordered" id="myTable">
            ...
            <tbody>
              <?php foreach ($orders as $order): $i++;?>
                ...
                <td class="text-center"><a href="#" class="btn btn-danger rounded-0 btn-sm" onclick="event.preventDefault(),viewMyOrder(<?php echo $order['client_id'] ?>),$('#modalOrder').modal('show')">View Orders</a></td>
              </tr>
              <?php endforeach ?>

...
if (isset($_POST['firstname']) && isset($_POST['lastname']) && isset($_POST['email']) && isset($_POST['phoneNumber']) && isset($_POST['gender']) && isset($_POST['address']) && isset($_POST['id']))
 {
   ...
   $response    =$client->updateClientInform($firstname,$lastname,$email,$phoneNumber,$gender,$dob,$address,$id);
   if($response ==  true)
   {

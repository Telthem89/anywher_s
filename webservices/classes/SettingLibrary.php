...
class SettingLibrary
{
	...
	/*-======================This will encriypt the openssl Algorithm==============================*/
	public static function Telthemwebencryptme($plainText, $cryptKey = '7R7zX2Urc7qvjhkr')
	{
		  $length   = 8;
		  $cstrong  = true;
		  $cipher   = 'aes-128-cbc';
...
/*-======================This will decriypt the openssl Algorithm==============================*/
	public static function Telthemwebdencryptme($encodedText, $cryptKey = '7R7zX2Urc7qvjhkr')
	{

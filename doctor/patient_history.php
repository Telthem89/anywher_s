...
elseif (isset($_SESSION['adminstatus'])) {
     ...
     $patienthist = $prescript->getPatientMedicalHistory($_SESSION['doctor_id']);
     // echo SettingLibrary::Telthemwebencryptme('hssshshs');
 ?>
<!DOCTYPE html>
<html>
    <head>
...
<h2 class="heading1 text-center p-2">My Patient List</h2>
<div class="agenda card rounded-0 p-3 mt-lg-5">

    <div class="table-responsive">
        <table class="table table-condensed table-borderless" id="myTable">
            <thead>
                <tr>
                    <th>[#Ref]</th>
                    <th>Fullname</th>
                ...
                <tbody>
                  ...
                  <?php $i=0; foreach ($patienthist as $patienthists): $i++;  ?>
                    <tr>
                      <td><?php echo $i; ?></td>
                      <td><?php echo $patienthists['fullname']; ?></td>
                      <td><?php echo $patienthists['gender']; ?></td>
                      <td><?php echo $patienthists['phoneNumber']; ?></td>
                      <td><?php echo $patienthists['email']; ?></td>
                      <td><?php echo $patienthists['age']; ?></td>
                      <td><a class="btn btn-danger rounded-0" href="patient_pres_history.php?q=<?php echo base64_encode($patienthists['client_id']); ?>">View Details</a></td>
                    </tr>
                  <?php endforeach ?>

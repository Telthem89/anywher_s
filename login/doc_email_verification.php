  ...
  <p><br></p>
   <div class="container">
       <div class="row justify-content-center">
        ...
        <div class="card mt-5">
            <div class="card-header">E-mail Address Confirmation Code</div>
            <div class="card-body">
                <form>
                    <div class="form-group">
                        <input type="number" id="emailCode" class="form-control" placeholder="Enter Code" maxlength="6" pattern="\d{6}" required>
                         <input type="hidden" id="email" class="form-control" placeholder="Enter Code" required >
                    </div>
                    <button type="button" class="btn btn-success btn-block" onclick="doc_ActivateAccount()">Submit Code</button>
                </form>
            </div>
        </div>
    </div>
   ...
   <p class="mt-5">&emsp;</p>
    <!-- Footer -->
    <footer class="ftco-footer mt-5" id="basic-footer">

...
<html>
    <head>
        ...
        <title>Anywhere dashboard-Suppliers</title>
    ...
    <body onload="LoadPharmacistFromLocalStorage_home(),GetAllSuppliers()">
        <!-- navbar-->
        <header class="header">
...
<li class="sidebar-list-item"><a href="supplier.php" class="sidebar-link text-muted active"><i class="o-medical-chart-1 mr-3 text-gray"></i><span>Manage Suppliers</span></a></li>
...
<h2 class="heading1 text-xl-center mb-4">Suppliers</h2>
<p class="lead heading2 text-xl-center">
    <button class="btn-primary btn-lg" onclick="$('#modalprimary').modal('show'),event.preventDefault()">Add new Supplier</button>
</p>
<hr class="line-break" />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #004085 !important; ">
                    <h4 style="color:#fff;" class="text-center" id="ctname">Add New Supplier</h4>
                </div>
                    ...
                    <form id="formReset">
                       <div class="alert alert-danger" role="alert" id="alert" style="display: none;"></div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="comapany_name" class="form-control" placeholder="Company Name">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="title">Physical Address</label>
                            <input type="text" id="address" class="form-control" placeholder="Physical Address">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label for="title">E-mail Address</label>
                            <input type="text" id="email" class="form-control" placeholder="Category Name">
                        </div>
                    
                        <input type="hidden" id="sid">
                        <button class="btn btn-warning btn-block" onclick="AddSupplier(),event.preventDefault()"  type="button" id="btnSupplier"> Add Supplier</button>
                        <button class="btn btn-info btn-block" onclick="UpdateSupplierDetails(),event.preventDefault()"  type="button" id="btnUpdateSupplier" style="display: none;"> Update Category</button>
                    </form>

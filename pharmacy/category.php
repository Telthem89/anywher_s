...
<html>
    ...
    <body onload="LoadPharmacistFromLocalStorage_home(),GetAllCategories()">
        <!-- navbar-->
        <header class="header">
...
<li class="sidebar-list-item"><a href="category.php" class="sidebar-link text-muted active"><i class="o-medical-chart-1 mr-3 text-gray"></i><span>Manage Categories</span></a></li>
...
<h2 class="heading1 text-xl-center mb-4">Categories</h2>
<p class="lead heading2 text-xl-center">
    <button class="btn-primary btn-lg" onclick="$('#modalprimary').modal('show'),event.preventDefault()">Add new Category</button>
</p>
<hr class="line-break" />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #004085 !important; ">
                    <h4 style="color:#fff;" class="text-center" id="ctname">Add New Category</h4>
                </div>
                <div class="modal-body">
                    <form id="formReset">
                       <div class="alert alert-danger" role="alert" id="alert" style="display: none;"></div>
                        ...
                        <button class="btn btn-warning btn-block" onclick="AddCategory(),event.preventDefault()"  type="button" id="btnCategory"> Add Category</button>
                        <button class="btn btn-info btn-block" onclick="UpdateCategoryDetails(),event.preventDefault()"  type="button" id="btnUpdateCategory" style="display: none;"> Update Category</button>
                    </form>
